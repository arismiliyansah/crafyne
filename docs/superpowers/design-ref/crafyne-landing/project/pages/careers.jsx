...
function CareersPage() {
  ...
  const apply = (role) => `mailto:hello@crafyne.studio?subject=Application: ${encodeURIComponent(role)}`;
      ...
      <section className="pageHero pageHero--crimson">
        <div className="wrap">
          <div className="pageHero__crumb reveal">
            <a href={P.home}>Crafyne</a><span>/</span><span>Careers</span>
          </div>
          <div className="pageHero__eyebrow reveal">/ careers · 2 open roles</div>
          <h1 className="pageHero__title reveal" data-d="1">
            Work with people<br/>
            <span className="italic" style={{fontFamily:'"Instrument Serif", serif', textTransform:'none', fontWeight:400}}>who finish things.</span>
          </h1>
        ...
        <div className="wrap">
          <div className="openings__head">
            ...
            <p className="reveal" data-d="2" style={{color:'var(--mute)', maxWidth:560, fontSize:17, marginTop:12}}>
              ...
              hire when a slot opens. Send a note to <a href="mailto:careers@crafyne.studio" style={{color:'var(--crimson)', fontWeight:600}}>careers@crafyne.studio</a>.
            </p>
          </div>
          <ul className="openings__list">
            {openings.map((o, i) => (
              <li className="opening reveal" data-d={i + 1} key={o.title} onClick={() => window.location.href = apply(o.title)}>
                <div>
                ...
                <div>
                  <span style={{fontSize:11, padding:'4px 10px', borderRadius:999, background:'var(--peach)', fontFamily:'JetBrains Mono', letterSpacing:'0.08em', textTransform:'uppercase'}}>{o.tag}</span>
                </div>
            ...
            <div className="cta__inner">
              <div className="cta__copy">
                ...
                <div className="cta__row reveal" data-d="3">
                  <a className="btn btn--orange cta__primary" href="mailto:careers@crafyne.studio">
                    Send a note
                  ...
                  <a className="cta__mail mono" href="mailto:careers@crafyne.studio">careers@crafyne.studio</a>
                </div>
              </div>
