      ...
      <section className="pageHero pageHero--ink">
        <div className="wrap">
          <div className="pageHero__crumb reveal">
            <a href={P.home}>Crafyne</a><span>/</span><span>About</span>
          </div>
          <div className="pageHero__eyebrow reveal">/ about the studio</div>
          <h1 className="pageHero__title reveal" data-d="1">
            We&rsquo;re six people.<br/>
            <span className="italic" style={{fontFamily:'"Instrument Serif", serif', textTransform:'none', fontWeight:400}}>Working on grown-up software.</span>
          </h1>
          <p className="pageHero__sub reveal" data-d="2">
            ...
            kept on purpose at six people, and we build software for teams that care how it feels.
          </p>
          <div className="pageHero__meta reveal" data-d="3">
            ...
            <div className="pageHero__metaItem"><span className="pageHero__metaLabel">Headcount</span><span className="pageHero__metaVal">6 full-time</span></div>
            <div className="pageHero__metaItem"><span className="pageHero__metaLabel">Headquartered</span><span className="pageHero__metaVal">Jakarta, ID</span></div>
            <div className="pageHero__metaItem"><span className="pageHero__metaLabel">Time zone</span><span className="pageHero__metaVal">UTC+7 · GMT-overlap 4h</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="aboutStory">
        <div className="wrap aboutStory__grid">
          <div className="reveal">
            ...
            <h2 className="aboutStory__title">
              Started in a kitchen. Stayed small on purpose.
            </h2>
          </div>
          <div className="aboutStory__body reveal" data-d="1">
            <p>
              Crafyne began in 2018 when Sari quit a director role at a payments company and started taking
              consulting projects from her kitchen table. Within a year there were three people. Within two,
              there was a clear thesis: stay senior, stay small, refuse the pull to scale.
            </p>
            <p>
              Eight years in, we&rsquo;re still six. We could be twenty. We&rsquo;ve said no to scaling four times
        ...
        <div className="wrap">
          <div className="aboutStudio__head">
            ...
            <p className="reveal" data-d="2" style={{color:'var(--mute)', maxWidth:380, fontSize:15}}>
              ...
              Open to visit when you&rsquo;re in Jakarta.
            </p>
          </div>
            ...
            <div className="cta__inner">
              <div className="cta__copy">
                ...
                <p className="cta__sub reveal" data-d="2">
                  One call, no slides. We&rsquo;ll tell you within the hour whether we&rsquo;re a fit
                  — and who to call if we&rsquo;re not.
                </p>
                <div className="cta__row reveal" data-d="3">
                  <a className="btn btn--orange cta__primary" href={P.page('contact')}>
