...
select * from (values
  ('Sprint','1–2 weeks · fixed scope','12,500','/project','One clear problem, shipped. Perfect for a prototype, a single feature, or unblocking a stalled build.', array['1 senior engineer + 1 designer','Fixed scope, fixed price','Production-ready, fully-typed code','Deployed to staging or your infra','Source code + handover notes'],'cream','Book a sprint',false,1),
  ('Build','6–14 weeks · full team','from 48,000','/project','Our core engagement. A senior pair takes your product from blank repo to a launched, maintainable codebase.', array['Senior engineer pair + part-time PM','Discovery, architecture & UX','Automated tests + CI/CD pipeline','Live staging from week one','Weekly demos — you own every commit','30-day post-launch support'],'crimson','Start a project',true,2),
  ('Tend','Large · multi-phase','from 96,000','/project','For ambitious, multi-phase products. A dedicated senior team, scoped phase by phase, taking you from architecture to scale.', array['Dedicated senior team','Multi-phase roadmap, fixed price per phase','Architecture built for scale','Automated tests + CI/CD','Design system + production code','Post-launch stabilization + handover'],'navy','Talk it through',false,3)
